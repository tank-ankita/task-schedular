...
public final class StdRandom {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < N; i++) {
			StdOut.format("%2d "  , uniform(100));
			StdOut.format("%8.5f ", uniform(10.0, 99.0));
			StdOut.format("%5b "  , bernoulli(.5));
			StdOut.format("%7.5f ", gaussian(9.0, .2));
			StdOut.format("%2d "  , discrete(t));
			StdOut.println();
		}
